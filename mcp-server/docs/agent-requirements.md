...
Follow the project's issue assignment rules:
- Parent/epic issues → Project 4 (Goal To Go Football)
- gridiron (API) issues → Project 1 (Gridiron Roadmap)
- gridiron-web issues → Project 3 (Web Roadmap)
- gridiron-engine issues → Project 2 (Engine Roadmap)
